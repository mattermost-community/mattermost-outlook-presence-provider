...
namespace CSExeCOMServer
{
    ...
    /// </summary>
    [ComVisible(false)]
    public class CSExeCOMServerBase
    {
        public CSExeCOMServerBase()
        {
        ...
        protected static void RegasmRegisterLocalServer(Type t)
        {
        ...
        /// </summary>
        /// <param name="t"></param>
        protected static void RegasmUnregisterLocalServer(Type t)
        {
